...
public class BookResource {
    ...
    static {
        ...
        memoryBase.put(1L, new Book(1L, "JSF2 face", "978711", "9787121177378", "2012-09-01"));
        memoryBase.put(2L, new Book(2L, "Java Restful Web Services I", "9787115375234", "9787111478881", "2014-09-01"));
        memoryBase.put(3L, new Book(3L, "Java EE 7", "978711222", "9787115375483", "2015-02-01"));
        memoryBase.put(4L, new Book(4L, "Java Restful Web Services II", "2015-04-01"));
    }
